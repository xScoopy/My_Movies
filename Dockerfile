...
RUN pip install Flask bson certifi chardet dnspython Flask-PyMongo gunicorn idna itsdangerous Jinja2 MarkupSafe prettyprinter pymongo python-dateutil python-dotenv requests six urllib3 Werkzeug
